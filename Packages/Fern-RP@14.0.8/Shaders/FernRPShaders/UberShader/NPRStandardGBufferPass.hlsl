...
void PreInitializeInputData(Varyings input, out InputData inputData, out FernAddInputData addInputData)
{
...
FragmentOutput LitGBufferPassFragment(Varyings input)
{
    ...
    half3 indirectLighting = FernIndirectLighting(brdfData, inputData, input, surfaceData.occlusion);

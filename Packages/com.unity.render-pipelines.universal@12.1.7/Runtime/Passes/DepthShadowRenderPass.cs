...
public class DepthShadowRenderPass : ScriptableRenderPass
    {
        ...
        /// </summary>
        public DepthShadowRenderPass(RenderPassEvent evt, RenderQueueRange renderQueueRange, LayerMask layerMask, int downSampler)
        {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            ConfigureTarget(
                ...
                descriptor.depthStencilFormat, desc.width, desc.height, 1, true);
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(URPProfileId.DepthShadowPrepass)))
            {

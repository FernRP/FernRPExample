...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    internal class DeferredLights
    {
        internal static class ShaderConstants
        {
            ...
            public static readonly int _NPRLitStencilRef = Shader.PropertyToID("_NPRLitDirStencilRef");
            public static readonly int _NPRLitStencilReadMask = Shader.PropertyToID("_NPRLitDirStencilReadMask");
            public static readonly int _NPRLitStencilWriteMask = Shader.PropertyToID("_NPRLitDirStencilWriteMask");
            ...
            public static readonly int _NPRLitDirStencilRef = Shader.PropertyToID("_NPRLitDirStencilRef");
            public static readonly int _NPRLitDirStencilReadMask = Shader.PropertyToID("_NPRLitDirStencilReadMask");
            public static readonly int _NPRLitDirStencilWriteMask = Shader.PropertyToID("_NPRLitDirStencilWriteMask");
        ...
        static readonly string[] k_StencilDeferredPassNames = new string[]
        {
            ...
            "Deferred Directional Light (NPRLit)",
            "ClearStencilPartial",
            "Fog",
            "SSAOOnly"
        };
        ...
        void RenderStencilDirectionalLights(CommandBuffer cmd, ref RenderingData renderingData, NativeArray<VisibleLight> visibleLights, int mainLightIndex)
        {
            ...
            for (int soffset = m_stencilVisLightOffsets[(int)LightType.Directional]; soffset < m_stencilVisLights.Length; ++soffset)
            {
                ...
                cmd.DrawMesh(m_FullscreenMesh, Matrix4x4.identity, m_StencilDeferredMaterial, 0, m_StencilDeferredPasses[(int)StencilDeferredPasses.DirectionalNPRLit]);
        ...
        void InitTileDeferredMaterial()
        {
            ...
            m_TileDeferredMaterial.SetFloat(ShaderConstants._NPRLitStencilRef, (float)StencilUsage.MaterialSimpleLit);
            m_TileDeferredMaterial.SetFloat(ShaderConstants._NPRLitStencilReadMask, (float)StencilUsage.MaterialMask);
            m_TileDeferredMaterial.SetFloat(ShaderConstants._NPRLitStencilWriteMask, 0.0f);
        }
        ...
        void InitStencilDeferredMaterial()
        {
            ...
            m_StencilDeferredMaterial.SetFloat(ShaderConstants._NPRLitDirStencilRef, (float)StencilUsage.MaterialNPRLit);
            m_StencilDeferredMaterial.SetFloat(ShaderConstants._NPRLitDirStencilReadMask, (float)StencilUsage.MaterialMask);
            m_StencilDeferredMaterial.SetFloat(ShaderConstants._NPRLitDirStencilWriteMask, 0.0f);

Shader "Hidden/Universal Render Pipeline/StencilDeferred"
{
    Properties {
        ...
        _NPRLitDirStencilRef ("NPRLitDirStencilRef", Int) = 0
        _NPRLitDirStencilReadMask ("NPRLitDirStencilReadMask", Int) = 0
        _NPRLitDirStencilWriteMask ("NPRLitDirStencilWriteMask", Int) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
         ...
         Pass
        {
            Name "Deferred Directional Light (NPRLit)"
            ...
            Stencil {
                Ref [_NPRLitDirStencilRef]
                ReadMask [_NPRLitDirStencilReadMask]
                WriteMask [_NPRLitDirStencilWriteMask]
                Comp Equal
                Pass Keep
                Fail Keep
                ZFail Keep

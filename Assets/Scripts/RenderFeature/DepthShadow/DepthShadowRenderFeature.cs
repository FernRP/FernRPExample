...
namespace FernNPR.Universal
{
    public class DepthShadowRenderFeature : ScriptableRendererFeature
    {
        ...
        [SerializeField]
        private DepthShadowSetting depthShadowSetting = new DepthShadowSetting();
        ...
        {
            m_DepthShadowPass = new DepthShadowRenderPass(RenderPassEvent.BeforeRenderingPrePasses, RenderQueueRange.opaque, depthShadowSetting.m_LayerMask, depthShadowSetting.downSample);

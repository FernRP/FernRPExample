Shader "FernRender/URP/FERNNPRStandard"
{
    Properties
    {
        ...
        [Sub(Rim._SCREENSPACERIM)] _DepthRimLightCameraDistanceStart("Camera Distance Fadeout Start",Range(0,500)) = 20
        [Sub(Rim._SCREENSPACERIM)] _DepthRimLightCameraDistanceFadeoutEnd("Camera Distance Fadeout End",Range(0,500)) = 80
